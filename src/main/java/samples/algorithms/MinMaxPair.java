 ...
 *
 * Exercise taken from Algorithm Design Manual book by Skiena.
 */
public class MinMaxPair {

	public static void main(String[] args) {

		List<Integer> list = Arrays.asList(8, 6, 2, 3, 4, 7, 1, 5);

		Collections.sort(list); // modifies list   O(n log n)
